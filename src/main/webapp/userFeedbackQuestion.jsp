...
<section class="FeedbaclMain Main">
    <ul class="cate">
        <li ><a href="userFeedback.jsp" class="a1">在线反馈</a></li>
        <li class="on first" ><a href="#" class="a2">常见问题</a></li>
    ...
    <div class="conbox">
        ...
        <div class="problem-box">
            <ul>
                ...
                <li>
                    <div>
                        <h3><span>提问：</span>牙周病引起的牙齿松动 吃什么药物控制一下？？</h3>
                        <p class="p1">因牙周病引起满口牙缝变宽，牙齿松动，吃饭时咬合不利索，硬的食物和酸的事务都不能吃，请问医生有什么方法可以缓解？</p>
                    </div>
                    <dl>
                        <span>回复内容:</span>
                        <div>
                            <p style="margin:0;">您好，牙周炎药物治疗效果是比较差的，</p>
                            <p style="margin:2px 0px;">因此最好是尽早到口腔科进行洗牙上药或者是龈下刮治。</p>
                        </div>
                    </dl>
                </li>
