...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#idNum").blur(function(){
                var value = $("#idNum").val().trim();
                if(value==""){
                    $("#span2").html("<font color='red'>身份证不能为空</font>");
                    isIdNum = false;
                    return;
                } else{
                    $("#span2").html("");
            ...
            $("form").submit(function(){
                return isName&&isIdNum&&isVerification;
            })
...
<section class="DoctorMain Main">
    <div class="dl-title"><a href="#">忘记密码</a></div>
    <div class="mima-bg">
        <form action="/user/verificationUser" method="post">
            <table class="">
                ...
                <tr>
                    <td><span>身份证号:</span><input type="text" class="text" name="idNum" id="idNum"/></td>
                    <td><span id="span2"></span></td>
                </tr>
                <tr>
                    <td><span>验证码:</span><input type="text" class="text text2" id="verification" name="code"/><img src="/user/YZM" alt="未显示图片" id="imgObj" /><a href="javascript:void(0);" id="changeImg" >换一张</a><br/></td>
                    <td><span id="span3"></span></td>
                </tr>

                <tr>
                    <td><input type="submit" class="button1" value="确定"/></td>
                </tr>
            </table>
        </form>
    </div>
