    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#verification").blur(function(){
                ...
                if(value==""){
                    $("#span3").html("<font color='red'>验证码不能为空</font>");
                    isVerification = false;
                    return;
                }else if(value!="8361"){
                    $("#span3").html("<font color='red'>验证码错误</font>");
                    isVerification = false;
                    return;
                }else{
                    $("#span3").html("<font color='green'>验证码正确</font>");
                    isVerification = true;
                }
            })

            $("form").submit(function () {
                return isName&&isPassword&&isVerification;
            })
...
<section class="DoctorMain Main">
    <div class="dl-title"><a href="consultantLogin.jsp">会员登录</a></div>
    <div class="dl-bg">
        <form action="/user/login" method="post">
            <table class="">
                ...
                <tr>
                    <td><span>验证码:</span><input type="text" class="text text2" id="verification"/><a class="yzm" href="#"></a></td>
                    <td><span id="span3"></span></td>
                </tr>
                <tr>
                    <td><input type="submit" class="button1" value="确定"/><a class="zuce" href="consultantsRegister.jsp">注册</a><em>|</em><a
                            class="mima" href="forgetPassword.jsp">忘记密码？</a></td>
                </tr>
            </table>
        </form>
    </div>
