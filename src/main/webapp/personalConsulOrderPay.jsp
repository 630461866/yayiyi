    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".a1").click(function () {
                ...
                if(value!=null){
                    $(".a1").attr("href","personal/paySuccess?orderId="+${orderId});
                }else{
                    layer.msg('请选择支付方式!', {icon: 5,time:2000});
                    return;
                }
            })
    ...
    <div class="conbox">
        ...
        <div class="mainCont">
            ...
            <div class="payBox Dt">
                ...
                <div class="pay-page">
                    <div class="buy-total">
                        <h2><p>项目名：${projectName}</p></h2>
                        <h2><p><a>应支付：${orderPrice}</a></p></h2>
                    </div>
                    <div class="pay-way">
                        <h3><a>支付宝</a></h3>
                        <p>支付宝支付方式</p>
                        <dl>
              <span class="sp1">
                <input type="radio" class="radio1" name="aa"/>
                ...
                <img src="images/66.jpg" />
                    ...
                    <div class="last-submit">   <h2 >  <a href="javascript:void(0)" class="a1"> 确认支付 </a></h2></div>
                </div>
                <!--end-->
            </div>
