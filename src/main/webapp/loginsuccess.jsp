...
<div class="Hcontainer">
    ...
    <section class="H-consulting">
        ...
        <ul class="H-consul-box">
            ...
            <li>
                <a href="#" class="img"><img src="images/himg2.png"></a>
                <a href="#" class="txt">保健医生<em>Care doctor</em></a>
            </li>
            <li>
                <a href="#" class="img"><img src="images/himg3.png"></a>
                <a href="#" class="txt">专科医生<em>Specialized</em></a>
            </li>
        </ul>
        <div class="H-loginbox">
            <div class="loginform">
                <form action="" method="get">
                    <dl>${name}，欢迎您</dl>
                    <a href="personalData.jsp">会员中心</a>
                </form>
            </div>
        </div>
        <div class="clear"></div>
