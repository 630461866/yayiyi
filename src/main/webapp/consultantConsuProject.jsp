        ...
        $(function () {
            $(".aa li").each(function () {
                $(this).click(function () {
                    ...
                    $(".a_next").attr("href","/project/selectDoctor?projectName="+projectName);
                })
            })
        })
    ...
    <div class="conbox">
        ...
        <div class="siderDoc">
            <ul>
                ...
                <li class="on"><a href="/project/list">选择咨询项目</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
        ...
        <div class="mainCont">
            <div class="contDoc">
                <ul class="aa">
                    ...
                    <li ><a href="javascript:void(0)">${project.projectName}</a></li>
                    </c:forEach>
                    <%--<li class="on"><a href="#">多学科咨询</a></li>--%>
                    <%--<li><a href="#">多学科咨询</a></li>--%>
                    <%--<li><a href="#">多学科咨询</a></li>--%>
                    <%--<li><a href="#">多学科咨询</a></li>--%>
                    <%--<li><a href="#">多学科咨询</a></li>--%>
                    <%--<li><a href="#">多学科咨询</a></li>--%>
                ...
                <wtl:Pager   PageSize="5" TargetID="mylist1" Footer="5" IsNullShow="true">
                    <div class='Pages'>
                        <span class='p_page'>
                            <%--<a  href='{$NextPageUrl}' class='a_next '>下一步</a>--%>
                            <a  href="/project/selectDoctor" class='a_next '>下一步</a>
