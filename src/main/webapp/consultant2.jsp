...
<section class="DoctorMain Main">
    <ul class="cate">
        <li ><a href="consultant.jsp" class="a1">会诊医生</a></li>
        <li class="on first"><a href="consultant2.jsp" class="a2">保健医生</a></li>
    ...
    <div class="conbox">
        <div class="siderDoc">
         ...
         <img src="images/doctor3_pic1.jpg" width="300" height="300" style="position:relative;top:90px;left: 200px">
