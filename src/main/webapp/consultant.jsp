...
<aside class="banner ban" style=" background:url(uploadfiles/h01.jpg) no-repeat top center; height:210px;">
    <div class="banlink">
        <a href="consultantLogin.jsp" class="a1">会员登录</a>
        <a href="/doctor/info" class="a2">名医推荐</a>
        <a href="qq.html" class="a3">咨询客服</a>
    </div>
</aside>
<!--图片切换 End-->
...
<section class="DoctorMain Main">
    <ul class="cate">
        <li class="on first"><a href="consultant.jsp" class="a1">会诊医生</a></li>
        <li ><a href="consultant2.jsp" class="a2">保健医生</a></li>
        <li ><a href="consultant3.jsp" class="a3">专科医生</a></li>
        <li ><a href="consultant4.jsp" class="a4">专家医生</a></li>
    </ul>
    <div class="conbox">
        <div class="siderDoc">
            <ul>
                ...
                <li ><a href="/project/list">选择咨询项目</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
                <li><a href="consultantSelectDoctor.jsp">选择医生</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
                <li><a href="consultantSubmitMessage.jsp">提交咨询信息</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
                <li><a href="consultantOrderPay.jsp">订单支付</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
                <li><a href="consultantPaySuccess.jsp">完成</a></li>
            </ul>
        </div>
         ...
         <img src="images/ww.jpg" width="300" height="300" style="position:relative;top:90px;left: 200px">
