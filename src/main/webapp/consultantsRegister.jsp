    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#password").blur(function(){
                ...
                if(value==""){
                    $("#span3").html("<font color='red'>密码不能为空</font>");
                    isPassword = false;
                    return;
                } else{
                    $("#span3").html("");
            ...
            $("#verification").blur(function(){
                var value = $("#verification").val().trim();
                if(value==""){
            ...
            $("form").submit(function(){
                return isName&&isEmail&&isPassword&&isVerification;
            })
...
<section class="DoctorMain Main">
    <div class="dl-title"><a href="consultantsRegister.jsp">注册</a></div>
    <div class="zc-bg">
        <form action="user/register" method="post">
            <table class="">
                <tr>
                    <td><span>用户名:</span><input type="text" class="text" name="name" id="name"/></td>
                    <td><span id="span1"></span></td>
                </tr>
                <tr>
                    <td><span>邮箱:</span><input type="text" class="text" name="email" id="email"/></td>
                    <td><span id="span2"></span></td>
                </tr>
                <tr>
                    <td><span>密码:</span><input type="password" class="text" name="password" id="password"/></td>
                    <td><span id="span3"></span></td>
                </tr>
                <tr>
                    <td><span>验证码:</span><input type="text" class="text text3" id="verification" name="code"/><img src="/user/YZM" alt="未显示图片" id="imgObj" /><a href="javascript:void(0);" id="changeImg" >换一张</a></td>
                    <td><span id="span4"></span></td>
                </tr>
                <tr>
                    <td><input type="submit" class="button1" value="确定"/><input type="button" class="button2" value="重置"/></td>
                </tr>
            </table>
        </form>
    </div>
