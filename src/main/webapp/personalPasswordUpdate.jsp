    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#password").blur(function(){
                var value = $("#password").val().trim();
                if(value==""){
                    $("#span1").html("<font color='red'>新密码不能为空</font>");
                    isPassword = false;
                    return;
                }else{
                    $("#span1").html("");
            ...
            $("#newPasswordVerify").blur(function(){
                var value = $("#password").val().trim();
                var value2 = $("#newPasswordVerify").val().trim();
                if(value2==""){
                    $("#span2").html("<font color='red'>确认密码不能为空</font>");
            ...
            $("form").submit(function(){
                return isPassword&&isVerifyPassword;
            })
        })
    </script>
</head>
    ...
    <div class="conbox">
        <div class="siderMem">
            <ul>
                ...
                <li class="on"><a href="personalPasswordUpdate.jsp" class="a2" >密码修改</a></li>

                <li><a href="personalGoodsOrder.jsp" class="a3">商品订单</a></li>

                <li><a href="personalReturnGoods.jsp" class="a4">商品退换货</a></li>

                <li><a href="personalConsulOrder.jsp" class="a5">咨询订单</a></li>
        ...
        <div class="mainCont">
            ...
            <div class="password-box">
                <table class="table2">
                    ...
                    <tr>
                        <td><span>新密码:</span><input type="password" class="text" name="password" id="password"/></td>
                        <td><span id="span1"></span></td>
                    </tr>

                    <tr>
                        <td><span>新密码确认:</span><input type="password" class="text" name="newPasswordVerify" id="newPasswordVerify"/></td>
                        <td><span id="span2"></span></td>
                    </tr>
                    <tr>
                        <td><input type="submit" class="button1"  value="修改"/><a href="personalPasswordUpdate.jsp"><input type="button" class="button2" value="重置" /></a></td>
                    </tr>
                </table>
            </div>
            <!--end-->
