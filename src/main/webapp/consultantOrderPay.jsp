    ...
    <div class="conbox">
        ...
        <div class="mainCont">
            ...
            <div class="orderDoc">
                ...
                <h4><span>订单金额：</span></h4>
                <p>共计：<span>360</span>元</p>
                <h4><span>支付方式：</span></h4>
                <a class="payimg" href="#"><img src="images/doctor_pay_icon.jpg" /></a>
                <div><a  href="consultantPaySuccess.jsp">确认支付</a></div>
            </div>
