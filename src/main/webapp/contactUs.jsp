...
<!--图片切换 End-->
<aside class="Current"><em></em><a href="index.jsp">首页</a> > <span>联系我们</span></aside>

<section class="AboutMain Main">
    <ul class="cate">
        <li class="on first"><a href="contactUs.jsp" class="a1">联系方式</a></li>
    </ul>
    ...
    <div class="conbox">
        <div class="singlepage">
            ...
            <p style="font-size:1.2em; margin:0; line-height:28px;"><H1>前台客服电话：0755—8888—8888</H1></p>
            <p style="font-size:1.2em;margin:0; line-height:28px;"><H1>微信：13588889999</H1></p>
