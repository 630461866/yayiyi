...
<section class="AboutMain Main">
    <ul class="cate">
        <li class="on first"><a href="aboutus.jsp" class="a1">品牌背景</a></li>
        <li ><a href="companyBackground.jsp" class="a2">公司背景</a></li>
        <li ><a href="salesChannels.jsp" class="a3">销售渠道</a></li>
    ...
    <div class="conbox">
        <div class="singlepage">
            <img src="images/about_pic1.png" width="364" height="358"  style=" float:right; margin-left:20px;" />
            <p style="font-size:1.2em; margin:0; line-height:28px;">1、优化网站结构和美工设计，让网站在视觉上更专业并且更符合公司产品的品质感、更符合客户使用习惯。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">2、让访问者进入网站的时候就有深入了解产品的需求，同时在产品展示和客户服务模块重点开发，提高用户体验、加强客户对产品的信任感，并激发客户的咨询购买欲望。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">3、网站访问的高效和速度保障。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">4、高效便捷的操作后台便于日常管理。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">5、专业快捷的后期维护服务。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">6、让访问者进入网站的时候就有深入了解产品的需求，同时在产品展示和客户服务模块重点开发，提高用户体验、加强客户对产品的信任感，并激发客户的咨询购买欲望。网站访问的高效和速度保障。高效便捷的操作后台便于日常管理。专业快捷的后期维护服务。展示和客户服务模块重点开发，提高用户体验、加强客户对产品的信任感，并激发客户的咨询购买欲望。网站访问的高效和速度保障。</p>
            <p style="font-size:1.2em;margin-top:40px; line-height:28px; text-align:center;">客户服务模块重点、专业快捷的后期维护服务。</p>
        </div>
    </div>
