...
<section class="AboutMain Main">
    <ul class="cate">
        ...
        <li class="on first"><a href="companyBackground.jsp" class="a2">公司背景</a></li>
    ...
    <div class="conbox">
        <div class="singlepage">
            <img src="images/GSBJ.png" width="364" height="358"  style=" float:right; margin-left:20px;" />
            <p style="font-size:1.2em; margin:0; line-height:28px;">1、三丸医疗是一家中国牙科医疗企业，公司拥有优秀的技术团队和以肖程鹏先生为代表的中国专家团队构成了公司强大的技术保障，公司力争以最新技术和产品服务于广大中外客户。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">2、我们深深懂得：品质和服务是我们的生命线，而品质的保障来源于细节。因此我们以选择优质材料、执行严格的高标准制作工艺、强化加工成品的包装和产品说明书以及质保卡入手，建立起完整的一套产品质量保障体系，使我们的加工产品让 医生和患者满意和放心。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">3、作为牙科医疗企业，我们只能有一个理由：就是把最优质的产品奉献给我们亲爱的客户。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">4、三丸牙科医疗愿为广大口腔医疗工作者竭诚服务。在与您认识中交朋友，在交往中与你们共同体会快乐。因为我们做的是一件对社会，对人们身心健康极其伟大的工作。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">5、专业快捷的后期康复服务。</p>
            <p style="font-size:1.2em;margin:0; line-height:28px;">6、三丸牙科医疗将用最真诚的怀抱，迎接您的到来！</p>
        </div>
    </div>
