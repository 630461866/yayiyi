                    ...
                    <div class="bookcontent">
                        ...
                        <ul style="display: block;">
                            ...
                            <li>
                                <div class="carbox">
                                    <div class="sp6">
                                        <a href="/goods/check?orderNumber=${good.goodsName}&orderDate=${good.orderDate}&orderSate=${good.orderStatus}&orderPrice=${good.orderPrice}&orderTotalPrice=${good.orderTotalPrice}" style=" cursor:pointer;">查看</a>
                                        <a class="status-list" data="取消" rel="100451693" href="/goods/orderConfirm?goodsId=${goodsId}" style=" cursor:pointer;">支付</a></div>
                                    <div class="sp5"><span>${good.orderStatus}</span><a href="/goods/check?orderNumber=${good.goodsName}&orderDate=${good.orderDate}&orderSate=${good.orderStatus}&orderPrice=${good.orderPrice}&orderTotalPrice=${good.orderTotalPrice}">跟踪</a></div>
                                    <div class="sp4"><span><fmt:formatDate value="${good.orderDate}" pattern="yyyy-MM-dd"/></span></div>
                                    <div class="sp3">
                                        <span>￥${good.orderTotalPrice}</span>
                                    </div>
                                    <div class="sp2"><span>${userName}</span></div>
                                    <div class="sp1">
                                        <a href="#"><img src="images/${good.orderPicture}" width="101" height="55"></a>
                                        <h6 class="h6"><a href="#">${good.goodsName}</a></h6>

                                    </div>
                                    <div class="sp0"><span>${good.orderNumber}</span></div>
                                </div>
                            </li>
                            <!--从这里循环end-->
                            </c:forEach>
                        ...
                        <%--<ul style="display: block;">--%>
                            ...
                            <%--<li>--%>
                                <%--<div class="carbox">--%>
                                    ...
                                    <%--<div class="sp5"><span>待支付</span><a href="#">跟踪</a></div>--%>
                            ...
                            <%--<li>--%>
                                <%--<div class="carbox">--%>
                                    <%--<div class="sp6">--%>
                                        <%--<a href="#" style=" cursor:pointer;">查看</a>--%>
                                        <%--<a class="status-list" data="取消" rel="100451693" href="javascript:void(0)" style=" cursor:pointer;">支付</a></div>--%>
                                    <%--<div class="sp5"><span>待收货</span><a href="#">跟踪</a></div>--%>
                                    <%--<div class="sp4"><span>2011－1－1<br />12：00：00</span></div>--%>
                                    <%--<div class="sp3">--%>
                                        <%--<span>￥1802.00</span>--%>
                                    <%--</div>--%>
                            ...
                            <%--<li>--%>
                                <%--<div class="carbox">--%>
                                    <%--<div class="sp6">--%>
                                        <%--<a href="#" style=" cursor:pointer;">查看</a>--%>
                                        <%--<a class="status-list" data="取消" rel="100451693" href="javascript:void(0)" style=" cursor:pointer;">支付</a></div>--%>
                                    <%--<div class="sp5"><span>待评价</span><a href="#">跟踪</a></div>--%>
                                    <%--<div class="sp4"><span>2011－1－1<br />12：00：00</span></div>--%>
                                    <%--<div class="sp3">--%>
                                        <%--<span>￥1802.00</span>--%>
                                    <%--</div>--%>
