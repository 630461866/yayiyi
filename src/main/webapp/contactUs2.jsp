        ...
        <div class="head-Right">
            ...
            <div class="language-select">
                ...
                <ul class="language-menu">
                    <li><a href="contactUs2.jsp">ENGLISH</a></li>
                    <li><a href="contactUs.jsp">Chinese</a></li>
                </ul>
            </div>
            <div class="Searchbox">
...
<!--图片切换-->
<aside class="banner ban" style=" background:url(images/LXWM.png) no-repeat top center; height:210px; width: 800px">
    <!--<div class="banlink">
...
<!--图片切换 End-->
<aside class="Current"><em></em><a href="index.jsp">home</a> > <span>about us</span></aside>

<section class="AboutMain Main">
    <ul class="cate">
        <li class="on first"><a href="contactUs.jsp" class="a1">contact information </a></li>
    </ul>
    ...
    <div class="conbox">
        <div class="singlepage">
            ...
            <p style="font-size:1.2em; margin:0; line-height:28px;"><H1>customer service phone：0755—8888—8888</H1></p>
            <p style="font-size:1.2em;margin:0; line-height:28px;"><H1>weixin：13588889999</H1></p>
            <p style="font-size:1.2em;margin:0; line-height:28px;"><H1>QQ：666888999</H1></p>
        </div>
    </div>
