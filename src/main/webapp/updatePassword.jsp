    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#password").blur(function(){
                var value = $("#password").val().trim();
                if(value==""){
                    $("#span1").html("<font color='red'>密码不能为空</font>");
                    isPassword = false;
                    return;
                }else{
                    $("#span1").html("");
            ...
            $("#verifyPassword").blur(function(){
                var value = $("#password").val().trim();
                var value2 = $("#verifyPassword").val().trim();
                if(value2==""){
...
<section class="DoctorMain Main">
    <div class="dl-title"><a href="#">修改密码</a></div>
    <div class="mima-bg">
        <form action="/user/resetPassword" method="post">
            <table class="">
                <tr>
                    <td><input type="hidden" class="text" name="id" value="${id}"/></td>
                </tr>
                <tr>
                    <td><span>密码</span><input type="text" class="text" name="password" id="password"/></td>
                    <td><span id="span1"></span></td>
                </tr>
                <tr>
                    <td><span>确认密码</span><input type="text" class="text" name="verifyPassword" id="verifyPassword"/></td>
