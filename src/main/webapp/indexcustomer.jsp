...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <%--<dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="article-list.html" href="javascript:void(0)">咨询信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a _href="user/selectByCondition" href="javascript:void(0)">用户管理</a></li>
                    <li><a _href="userFeedback/userFeedbacklist" href="javascript:void(0)">用户反馈</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="departments/departmentslist" href="javascript:void(0)">部门管理</a></li>
                    <li><a _href="doctor/doctorlist" href="javascript:void(0)">会诊医生</a></li>
                    <li><a _href="product-category.html" href="javascript:void(0)">保健医生</a></li>
                    <li><a _href="product-list.html" href="javascript:void(0)">专科医生</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a _href="http://h-ui.duoshuo.com/admin/" href="javascript:;">商品管理</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a _href="consultProject/consulprojjectlist" href="javascript:;">医疗项目管理</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a _href="auth/showAuthPage" href="javascript:;">权限管理管理</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-order">
            ...
            <dd>
                <ul>
                    <li><a _href="goods/goodslist" href="javascript:void(0)">商品订单管理</a></li>
                    <li><a _href="recharge-list.html" href="javascript:void(0)">咨询订单管理</a></li>
                </ul>
            </dd>
        </dl>
        &lt;%&ndash;<dl id="menu-member">
