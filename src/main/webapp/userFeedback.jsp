    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".button1").click(function () {
             ...
             //  alert(username);
                if(username==""){
                    layer.msg('请填写完所有信息!', {icon: 5,time:5000});
                    return;
                }else{
                    layer.msg('您的反馈已提交!', {icon: 6,time:3000}
                    );
...
<!--图片切换 End-->
<aside class="Current"><em></em><a href="index.jsp">首页</a> > <span>用户反馈</span></aside>

<section class="FeedbaclMain Main">
    <ul class="cate">
        <li class="on first"><a href="#" class="a1">在线反馈</a></li>
        <li ><a href="userFeedbackQuestion.jsp" class="a2">常见问题</a></li>
    ...
    <div class="conbox">
        ...
        <div class="feedback-box">
            <form action="userFeedback/addUserFeedback" method="post" class="ee">
                <table class="table">
                    <tr>
                        <td colspan="2"><span>标题:</span><input type="text " class="text text2" name="title"/></td>
                    </tr>
                    <tr>
                        <td><span>姓名:</span><input type="text" class="text" name="name" id="name" /></td>
                    </tr>
                    <tr>
                        <td><span>手机:</span><input type="text" class="text" name="phone"/></td>
                    </tr>
                    <tr>
                        <td colspan="2"><span>邮箱:</span><input type="text" class="text " name="email"/></td>
                    </tr>
                    <tr>
                        <td colspan="2"><span>内容:</span><input type="textarea" class="textarea" name="content"/></td>
                    </tr>
                    <tr>
                        <td colspan="2"><input type="button" class="button1" value="确定"><input type="button" class="button2" value="重置"></td>
                    </tr>
                </table>
            </form>
        </div>
