...
<section class="MemberMain Main">
    ...
    <div class="conbox">
        <div class="siderFamous">
            <ul>
                <li class="on"><a href="#" class="a1">会诊医生</a></li>

                <li><a href="#" class="a2">保健医生</a></li>

                <li><a href="#" class="a3">专科医生</a></li>

                <li><a href="#" class="a4">专家医生</a></li>
            </ul>
        </div>
        ...
        <div class="mainCont">
            ...
            <div class="famousBox2 Dt">
                ...
                <div class="doctor-list2">
                    <ul>
                        <li>
                            <a class="imgBox"><img src="images/famous_pic1.jpg"></a>
                            <p class="p2"><span>姓名:</span>曾任</p>
                            <p class="p2"><span>职务:</span>-</p>
                            <p class="p2"><span>职称:</span>主任医师</p>
                            <p class="p2"><span>科室:</span>保健科</p>
                            <p class="p2"><span>电话:</span>020-888954442</p>
                        </li>
                        <div class="clear"></div>
                    ...
                    <div class="getback">
                        <p><a href="#">返回</a></p>
                        <dl>
                            <span class="sp1">上一篇：<a href="#">曾任</a></span>
                            <span class="sp2">下一篇：<a href="#">曾任</a></span>
                        </dl>
                    </div>
                </div>
                <!--end-->
