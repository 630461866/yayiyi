...
<section class="HealthMain Main">
    <ul class="cate">
        ...
        <li class="on first"><a href="bromopnea.jsp" class="a2">口臭</a></li>
        ...
        <article class="NewsList">
            <ul>
                <article class="topnews">
                    <figure class="fimg">
                        <a href="#"><img src="images/KCSY.png" width="186" height="127"></a>
                    </figure>
                    <h3 class="h3"><a href="#">坚持这些良好习惯让你远离口臭</a></h3>

                    <p>	生活中几乎很多让人都遭遇过口臭的困扰，许多人认为口臭问题只要勤刷牙就会自愈。专家表示，这些认识有一定正确性，但也不尽如此。北京大学深圳医院口腔科主任医师解佳伟解释，引发口臭的原因有许多。比如有..</p>
                    <a href="#" class="more">&gt;&gt; 查看更多</a>
                </article>

                <li><span><time pubtime="2019/12/19">2019/12/19</time></span><a href="#">有口臭的话，平时要忌口，不要抽烟喝酒，不要吃辛辣食物，要多饮水，口味要清淡</a></li>
                <li><span><time pubtime="2019/12/10">2019/12/10</time></span><a href="#">咀嚼苹果、芹菜和黄瓜等能有效去除食物残渣和牙菌斑，还能促进唾液分泌，保持口腔湿润。</a></li>
                <li><span><time pubtime="2019/11/28">2019/11/28</time></span><a href="#">咖啡会在舌头上留下一层薄膜，限制了氧气进入口腔，为细菌的生长（厌氧菌）创造了良好的环境。如果经常口臭，可以改喝茶来代替咖啡。</a></li>
                <li><span><time pubtime="2019/11/25">2019/11/25</time></span><a href="#">嚼口香糖能促进唾液分泌，让口腔保持湿润。由于口腔中的细菌会将糖分解为挥发性硫化物，所以要嚼无糖口香糖。</a></li>
                <li><span><time pubtime="2019/11/18">2019/11/18</time></span><a href="#">维生素D不利于口腔细菌的生长，因此可以食用一些富含维生素D的食品。</a></li>
                <li><span><time pubtime="2019/11/09">2019/11/09</time></span><a href="#">任何一种烟草制品都会引起口臭及容易散发出臭味的口腔疾病。</a></li>
                <li><span><time pubtime="2019/10/28">2019/10/28</time></span><a href="#">有研究显示，每天喝酸奶能减少引起口臭的细菌数量。</a></li>
